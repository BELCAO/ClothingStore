    ...
    var e = {
      ...
      startZoom: function () {
        ...
        "window" == e.options.zoomType &&
          ...
          (e.zoomWindow = isNaN(e.options.zoomWindowPosition)
            ? o(
          ...
          (e.minZoomLevel = e.options.minZoomLevel
            ...
            : 2 * e.options.scrollZoomIncrement),
        ...
        return e.options.zoomEnabled
          ? ((e.nzHeight = e.$elem.height()),
            ...
            e.mouseTop > e.nzHeight
              ? (e.setElements("hide"), void 0)
              : (e.options.showLens &&
                  ((e.lensLeftPos = String(
                    e.mouseLeft - e.zoomLens.width() / 2
                  )),
                  (e.lensTopPos = String(
                    e.mouseTop - e.zoomLens.height() / 2
                  ))),
        ...
        "show" == o &&
          ...
          "hide" == o &&
            ...
            (e.options.zoomWindowFadeOut
              ? e.zoomWindow.stop(!0, !0).fadeOut(e.options.zoomWindowFadeOut)
              : e.zoomWindow.hide(),
            (e.isWindowActive = !1));
      },
      ...
      setTintPosition: function (o) {
        ...
        (e.nzOffset = e.$elem.offset()),
          (e.tintpos = String(
            -1 * (o.pageX - e.nzOffset.left - e.zoomLens.width() / 2)
          )),
          (e.tintposy = String(
            -1 * (o.pageY - e.nzOffset.top - e.zoomLens.height() / 2)
          )),
