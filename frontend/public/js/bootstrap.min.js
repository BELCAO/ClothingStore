...
+(function (t) {
    ...
    function e() {
      t(o).remove(),
        t(n).each(function (e) {
          var o = i(t(this));
          o.hasClass("open") &&
            (o.trigger((e = t.Event("hide.bs.dropdown"))),
            e.isDefaultPrevented() ||
              o.removeClass("open").trigger("hidden.bs.dropdown"));
        });
    }
    function i(e) {
  ...
  +(function (t) {
    ...
    function e(i, o) {
      ...
      (this.$element = t(i).is("body") ? t(window) : t(i)),
        (this.$body = t("body")),
        ...
        if (this.$element.is(":visible")) {
          ...
          var l =
            null != this.unpin && o + this.unpin <= n.top
              ? !1
              : null != r && n.top + this.$element.height() >= i - r
              ? "bottom"
              : null != a && a >= o
              ? "top"
              : !1;
