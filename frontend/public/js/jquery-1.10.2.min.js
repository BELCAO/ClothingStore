!(function (e, t) {
  ...
  function i(e, n, r, i) {
    if (ct.acceptData(e)) {
      ...
      if ((c && l[c] && (i || l[c].data)) || r !== t || "string" != typeof n)
        return (
          c || (c = u ? (e[s] = tt.pop() || ct.guid++) : s),
          l[c] || (l[c] = u ? {} : { toJSON: ct.noop }),
          ("object" == typeof n || "function" == typeof n) &&
            (i
              ? (l[c] = ct.extend(l[c], n))
              : (l[c].data = ct.extend(l[c].data, n))),
          (a = l[c]),
          i || (a.data || (a.data = {}), (a = a.data)),
          r !== t && (a[ct.camelCase(n)] = r),
          "string" == typeof n
            ? ((o = a[n]), null == o && (o = a[ct.camelCase(n)]))
            : (o = a),
          o
        );
    }
  ...
  function h(e, t) {
    return ct.nodeName(e, "table") &&
      ct.nodeName(1 === t.nodeType ? t : t.firstChild, "tr")
  ...
  function w(e, t) {
    if (t in e) return t;
    for (
      var n = t.charAt(0).toUpperCase() + t.slice(1), r = t, i = kn.length;
      i--;
        ...
        r.style &&
          ...
          t
            ? (o[a] || "none" !== n || (r.style.display = ""),
              "" === r.style.display &&
                C(r) &&
                (o[a] = ct._data(r, "olddisplay", A(r.nodeName))))
            : o[a] ||
              ((i = C(r)),
              ((n && "none" !== n) || !i) &&
  ...
  function E(e, t, n, r, i) {
    for (
      ...
      "margin" === n && (a += ct.css(e, n + Nn[o], !0, i)),
        r
          ? ("content" === n && (a -= ct.css(e, "padding" + Nn[o], !0, i)),
            "margin" !== n &&
              (a -= ct.css(e, "border" + Nn[o] + "Width", !0, i)))
          : ((a += ct.css(e, "padding" + Nn[o], !0, i)),
            "padding" !== n &&
              (a += ct.css(e, "border" + Nn[o] + "Width", !0, i)));
    return a;
  }
  function S(e, t, n) {
    var r = !0,
      ...
      o = fn(e),
      a =
        ct.support.boxSizing && "border-box" === ct.css(e, "boxSizing", !1, o);
    if (0 >= i || null == i) {
      if (
        ((i = pn(e, t, o)),
  ...
  function P(e, t, n) {
    for (
      var r, i = (or[t] || []).concat(or["*"]), o = 0, a = i.length;
      a > o;
      o++
    )
  ...
  function R(e, t, n) {
    ...
    return (
      ...
      ct.fx.timer(ct.extend(u, { elem: e, anim: l, queue: l.opts.queue })),
      l
    ...
    n.queue ||
      ...
      1 === e.nodeType &&
        ...
        "inline" === ct.css(e, "display") &&
          "none" === ct.css(e, "float") &&
          (ct.support.inlineBlockNeedsLayout && "inline" !== A(e.nodeName)
            ? (f.zoom = 1)
  ...
  function z(e, t) {
    ...
    for (t = t ? 1 : 0; 4 > i; i += 2 - t)
      (n = Nn[i]), (r["margin" + n] = r["padding" + n] = e);
  ...
  var U,
    ...
    Nt = function () {
      G.addEventListener
        ? (G.removeEventListener("DOMContentLoaded", Ct, !1),
          e.removeEventListener("load", Ct, !1))
        : (G.detachEvent("onreadystatechange", Ct),
  ...
  (ct.fn = ct.prototype =
    ...
    ct.extend({
      ...
      noConflict: function (t) {
        return (
          e.$ === ct && (e.$ = Z), t && e.jQuery === ct && (e.jQuery = K), ct
        );
      },
      isReady: !1,
      readyWait: 1,
      ...
      ready: function (e) {
        if (e === !0 ? !--ct.readyWait : !ct.isReady) {
          ...
          (ct.isReady = !0),
            (e !== !0 && --ct.readyWait > 0) ||
              (U.resolveWith(G, [ct]),
              ct.fn.trigger && ct(G).trigger("ready").off("ready"));
        }
      },
      ...
      isPlainObject: function (e) {
        ...
        try {
          if (
            e.constructor &&
            !ut.call(e, "constructor") &&
            !ut.call(e.constructor.prototype, "isPrototypeOf")
          )
            return !1;
        } catch (r) {
          return !1;
      ...
      makeArray: function (e, t) {
        ...
        return (
          null != e &&
            (n(Object(e))
              ? ct.merge(r, "string" == typeof e ? [e] : e)
              : it.call(r, e)),
          r
        );
      },
    ...
    (ct.ready.promise = function (t) {
      if (!U)
        if (((U = ct.Deferred()), "complete" === G.readyState))
          setTimeout(ct.ready);
        else if (G.addEventListener)
          G.addEventListener("DOMContentLoaded", Ct, !1),
      ...
      function T(e, t, n, r) {
        ...
        if (!r && 1 === l.length) {
          if (
            ...
            if (
              ((t = (k.find.ID(a.matches[0].replace(Ct, Nt), t) || [])[0]), !t)
            )
              return n;
            e = e.slice(o.shift().value.length);
          }
          for (
            i = yt.needsContext.test(e) ? 0 : o.length;
            ...
            return n !== H && 9 === n.nodeType && n.documentElement
              ? ((H = n),
                ...
                (k.find.TAG = C.getElementsByTagName
                  ? function (e, n) {
                      return typeof n.getElementsByTagName !== Y
                ...
                (k.find.CLASS =
                  C.getElementsByClassName &&
                  function (e, n) {
                    return typeof n.getElementsByClassName !== Y && _
                      ? n.getElementsByClassName(e)
                      : t;
                  }),
                (O = []),
                (M = []),
                (C.qsa = vt.test(n.querySelectorAll)) &&
                  (o(function (e) {
                    (e.innerHTML =
                ...
                (B =
                  vt.test(q.contains) || q.compareDocumentPosition
                    ? function (e, t) {
          ...
          return (
            l &&
              ct.each(arguments, function (e, t) {
                for (var r; (r = ct.inArray(t, l, r)) > -1; )
  ...
  ct.extend({
    ...
    hasData: function (e) {
      return (
        (e = e.nodeType ? ct.cache[e[ct.expando]] : e[ct.expando]), !!e && !s(e)
      );
    },
    data: function (e, t, n) {
      return i(e, t, n);
    ...
    ct.fn.extend({
      data: function (e, n) {
        ...
        if (e === t) {
          if (
            this.length &&
            ((o = ct.data(u)), 1 === u.nodeType && !ct._data(u, "parsedAttrs"))
          ) {
            for (r = u.attributes; r.length > s; s++)
              (i = r[s].name),
                0 === i.indexOf("data-") &&
                  ((i = ct.camelCase(i.slice(5))), a(u, i, o[i]));
  ...
  ct.fn.extend({
    ...
    toggleClass: function (e, t) {
      ...
      return "boolean" == typeof t && "string" === n
        ...
        : this.each(function () {
            if ("string" === n)
              for (
                var t, r = 0, i = ct(this), o = e.match(pt) || [];
                (t = o[r++]);
    ...
    ct.extend({
      valHooks: {
        ...
        select: {
          ...
          set: function (e, t) {
            for (
              var n, r, i = e.options, o = ct.makeArray(t), a = i.length;
              a--;
        ...
        return e && 3 !== a && 8 !== a && 2 !== a
          ? typeof e.getAttribute === Y
            ...
            : ((1 === a && ct.isXMLDoc(e)) ||
                ((n = n.toLowerCase()),
                (i =
                  ct.attrHooks[n] || (ct.expr.match.bool.test(n) ? jt : At))),
              r === t
      ...
      propHooks: {
        tabIndex: {
          get: function (e) {
            ...
            return t
              ? parseInt(t, 10)
              : Ht.test(e.nodeName) || (qt.test(e.nodeName) && e.href)
              ? 0
              : -1;
          },
        },
      ...
      set: function (e, t, n) {
        return (
          t === !1
            ? ct.removeAttr(e, n)
            : (Ot && Mt) || !_t.test(n)
            ? e.setAttribute((!Mt && ct.propFix[n]) || n, n)
        ...
        (Ot && Mt) || !_t.test(n)
          ? function (e, n, i) {
              var o = ct.expr.attrHandle[n],
                a = i
                  ? t
                  : (ct.expr.attrHandle[n] = t) != r(e, n, i)
                  ? n.toLowerCase()
                  : null;
    ...
    ct.each(["radio", "checkbox"], function () {
      (ct.valHooks[this] = {
        set: function (e, n) {
          return ct.isArray(n)
            ? (e.checked = ct.inArray(ct(e).val(), n) >= 0)
            : t;
        },
      }),
        ct.support.checkOn ||
  ...
  (ct.event = {
        ...
        for (
          r.handler && ((l = r), (r = l.handler), (o = l.selector)),
            ...
            (f = y.handle) ||
              ((f = y.handle =
                function (e) {
                  return typeof ct === Y || (e && ct.event.triggered === e.type)
                    ? t
    ...
    trigger: function (n, r, i, o) {
      ...
      if (
        ...
        if (!o && !c.noBubble && !ct.isWindow(i)) {
          for (
            l = c.delegateType || h, Rt.test(l + h) || (u = u.parentNode);
            u;
            u = u.parentNode
          )
            d.push(u), (f = u);
        ...
        for (p = 0; (u = d[p++]) && !n.isPropagationStopped(); )
          (n.type = p > 1 ? l : c.bindType || h),
            (a =
              (ct._data(u, "events") || {})[n.type] && ct._data(u, "handle")),
            a && a.apply(u, r),
            (a = s && u[s]),
            a &&
              ct.acceptData(u) &&
    ...
    dispatch: function (e) {
      ...
      if (
        ...
        for (
          s = ct.event.handlers.call(this, e, l), n = 0;
          ...
          for (
            ...
            (!e.namespace_re || e.namespace_re.test(i.namespace)) &&
              ...
              (e.data = i.data),
              (r = (
                (ct.event.special[i.origType] || {}).handle || i.handler
              ).apply(o.elem, u)),
              r !== t &&
                (e.result = r) === !1 &&
    ...
    fix: function (e) {
      ...
      for (
        a ||
          (this.fixHooks[i] = a =
            Pt.test(i) ? this.mouseHooks : Bt.test(i) ? this.keyHooks : {}),
    ...
    ct.support.submitBubbles ||
      (ct.event.special.submit = {
        ...
        teardown: function () {
          return ct.nodeName(this, "form")
            ? !1
            : (ct.event.remove(this, "._submit"), t);
        },
      }),
  ...
  ct.fn.extend({
    ...
    is: function (e) {
      return !!p(this, "string" == typeof e && zt.test(e) ? ct(e) : e || [], !1)
        .length;
    },
      ...
      for (
        ...
        for (n = this[r]; n && n !== t; n = n.parentNode)
          if (
            ...
            (a
              ? a.index(n) > -1
              : 1 === n.nodeType && ct.find.matchesSelector(n, e))
          ) {
            n = o.push(n);
            break;
          }
      ...
      function (e, t) {
        ct.fn[e] = function (n, r) {
          ...
          return (
            ...
            this.length > 1 &&
              (Xt[e] || (i = ct.unique(i)), It.test(e) && (i = i.reverse())),
            this.pushStack(i)
          );
        };
      }
  ...
  (sn.optgroup = sn.option),
    ...
    ct.fn.extend({
      ...
      remove: function (e, t) {
        for (
          var n, r = e ? ct.filter(e, this) : this, i = 0;
          null != (n = r[i]);
          i++
        )
          t || 1 !== n.nodeType || ct.cleanData(x(n)),
            n.parentNode &&
              (t && ct.contains(n.ownerDocument, n) && y(x(n, "script")),
          ...
          function (e) {
            ...
            if (
              !(
                "string" != typeof e ||
                en.test(e) ||
                (!ct.support.htmlSerialize && Yt.test(e)) ||
                (!ct.support.leadingWhitespace && Jt.test(e)) ||
                sn[(Qt.exec(e) || ["", ""])[1].toLowerCase()]
              )
            ) {
              e = e.replace(Gt, "<$1></$2>");
              try {
                for (; i > r; r++)
                  (n = this[r] || {}),
                    1 === n.nodeType &&
                      (ct.cleanData(x(n, !1)), (n.innerHTML = e));
                n = 0;
              } catch (o) {}
            }
      ...
      domManip: function (e, t, n) {
        ...
        if (
          h ||
          (!(1 >= c || "string" != typeof d || ct.support.checkClone) &&
            nn.test(d))
        )
        ...
        if (
          c &&
          ((u = ct.buildFragment(e, this[0].ownerDocument, !1, !n && this)),
          (r = u.firstChild),
          1 === u.childNodes.length && (u = r),
          r)
        ) {
          for (a = ct.map(x(u, "script"), g), o = a.length; c > l; l++)
            (i = u),
              l !== p &&
                ((i = ct.clone(i, !0, !0)), o && ct.merge(a, x(i, "script"))),
              t.call(this[l], i, l);
          if (o)
            for (
              s = a[a.length - 1].ownerDocument, ct.map(a, m), l = 0;
              o > l;
              l++
            )
              (i = a[l]),
    ...
    ct.extend({
      clone: function (e, t, n) {
        var r,
          ...
          a,
          s,
          u = ct.contains(e.ownerDocument, e);
        if (
          (ct.support.html5Clone ||
          ct.isXMLDoc(e) ||
          !Yt.test("<" + e.nodeName + ">")
            ? (o = e.cloneNode(!0))
            : ((ln.innerHTML = e.outerHTML),
              ln.removeChild((o = ln.firstChild))),
          !(
      ...
      buildFragment: function (e, t, n, r) {
        for (
          var i, o, a, s, u, l, c, f = e.length, p = d(t), h = [], g = 0;
          f > g;
          g++
        )
          if (((o = e[g]), o || 0 === o))
            if ("object" === ct.type(o)) ct.merge(h, o.nodeType ? [o] : o);
              ...
              for (
                s = s || p.appendChild(t.createElement("div")),
                  ...
                  c = sn[u] || sn._default,
                  s.innerHTML = c[1] + o.replace(Gt, "<$1></$2>") + c[2],
                  i = c[0];
                i--;
              ...
              if (
                (!ct.support.leadingWhitespace &&
                  Jt.test(o) &&
                  h.push(t.createTextNode(Jt.exec(o)[0])),
                !ct.support.tbody)
              )
                for (
                  o =
                  ...
                  ct.nodeName((l = o.childNodes[i]), "tbody") &&
                    !l.childNodes.length &&
                    o.removeChild(l);
              for (
                ct.merge(h, s.childNodes), s.textContent = "";
                s.firstChild;
        ...
        for (
          s && p.removeChild(s),
            ct.support.appendChecked || ct.grep(x(h, "input"), T),
            g = 0;
          (o = h[g++]);
    ...
    ct.extend({
      ...
      style: function (e, n, r, i) {
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
          var o,
            ...
            l = e.style;
          if (
            ((n = ct.cssProps[u] || (ct.cssProps[u] = w(l, u))),
          ...
          if (
            ...
            "string" === a &&
              (o = xn.exec(r)) &&
              ((r = (o[1] + 1) * o[2] + parseFloat(ct.css(e, n))),
              (a = "number")),
            !(
              null == r ||
              ("number" === a && isNaN(r)) ||
              ("number" !== a || ct.cssNumber[u] || (r += "px"),
      ...
      css: function (e, n, r, i) {
        var o,
          ...
          u = ct.camelCase(n);
        return (
          (n = ct.cssProps[u] || (ct.cssProps[u] = w(e.style, u))),
          (s = ct.cssHooks[n] || ct.cssHooks[u]),
          s && "get" in s && (a = s.get(e, !0, r)),
          a === t && (a = pn(e, n, i)),
          "normal" === a && n in Cn && (a = Cn[n]),
          "" === r || r
            ? ((o = parseFloat(a)), r === !0 || ct.isNumeric(o) ? o || 0 : a)
            : a
        );
      },
    }),
            ...
            r
              ? E(
                  ...
                  ct.support.boxSizing &&
                    "border-box" === ct.css(e, "boxSizing", !1, i),
                  i
                )
              : 0
          );
    ...
    ct(function () {
      ct.support.reliableMarginRight ||
        (ct.cssHooks.marginRight = {
          get: function (e, n) {
            return n
              ? ct.swap(e, { display: "inline-block" }, pn, [e, "marginRight"])
              : t;
          },
        }),
          ...
          ct.each(["top", "left"], function (e, n) {
            ct.cssHooks[n] = {
              get: function (e, r) {
                return r
                  ? ((r = pn(e, n)),
                    bn.test(r) ? ct(e).position()[n] + "px" : r)
                  : t;
              },
            };
          });
  ...
  (Ln = Wn.exec(Hn.toLowerCase()) || []),
    ...
    ct.extend({
      ...
      ajax: function (e, n) {
        ...
        (l = p.global),
          ...
          p.hasContent ||
            (p.data &&
              ((a = p.url += (_n.test(a) ? "&" : "?") + p.data), delete p.data),
            p.cache === !1 &&
              (p.url = On.test(a)
                ? a.replace(On, "$1_=" + qn++)
                : a + (_n.test(a) ? "&" : "?") + "_=" + qn++)),
          p.ifModified &&
            (ct.lastModified[a] &&
              w.setRequestHeader("If-Modified-Since", ct.lastModified[a]),
            ct.etag[a] && w.setRequestHeader("If-None-Match", ct.etag[a])),
    ...
    ct.ajaxTransport("script", function (e) {
      if (e.crossDomain) {
        var n,
          r = G.head || ct("head")[0] || G.documentElement;
        return {
          send: function (t, i) {
      ...
      return u || "jsonp" === n.dataTypes[0]
        ? ((o = n.jsonpCallback =
            ct.isFunction(n.jsonpCallback)
              ...
              : n.jsonpCallback),
          u
            ? (n[u] = n[u].replace(Yn, "$1" + o))
            : n.jsonp !== !1 &&
              (n.url += (_n.test(n.url) ? "&" : "?") + n.jsonp + "=" + o),
              ...
              u.send((n.hasContent && n.data) || null),
                ...
                n.async
                  ? 4 === u.readyState
                    ? setTimeout(r)
                    : ((a = ++Qn),
                      Kn && (Jn || ((Jn = {}), ct(e).unload(Kn)), (Jn[a] = r)),
      ...
      "*": [
        function (e, t) {
          var n = this.createTween(e, t),
            ...
            a =
              (ct.cssNumber[e] || ("px" !== o && +r)) &&
              nr.exec(ct.css(n.elem, e)),
            s = 1,
            u = 20;
          if (a && a[3] !== o) {
            (o = o || a[3]), (i = i || []), (a = +r || 1);
      ...
      _default: {
        ...
        set: function (e) {
          ct.fx.step[e.prop]
            ? ct.fx.step[e.prop](e)
            : e.elem.style &&
              (null != e.elem.style[ct.cssProps[e.prop]] || ct.cssHooks[e.prop])
